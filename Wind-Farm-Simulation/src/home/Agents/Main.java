...
public class Main {
    ...
    public void startSimulation(int numberOfTurbines, String filePath) throws Exception {
        ...
        weathers = (ArrayList<Weather>) d.parseWeatherFromFile(filePath);
...
//        Weather.setWind("C:\\Users\\Zuzanna\\Desktop\\AGH\\Infa\\Semestr 4\\Wind-Farm-Simulation\\Wind-Farm-Simulation\\res\\windLinowo.csv", weathers);
    ...
    public void startSimulation(int numberOfTurbines, String location, String beginDate, String endingDate) throws Exception {
        turbines = new ArrayList<>();
        earnings = 0.0;
        turbineExpenses = 0.0;
        otherExpenses = 0.0;
...
//        }
    ...
    public String showSimulationResults(String[] args) throws Exception {
        StringBuilder msgToReturn = new StringBuilder();
        if (args[0] == "fromApi") {
            startSimulation(new Integer(args[1]), args[2], args[3], args[4]);

        } else if (args[0] == "fromFile") {
            startSimulation(new Integer(args[1]), "/res/weather" + args[2] + ".csv");
